 ...
 */
@Service
public class CommentHugList extends SimpleApiModule {
    ...
    public void genParams(ObjectNode node, Map<String, Object> queryMap) {
        ...
        node.put("cursor", StrUtil.nullToDefault((String) queryMap.get("cursor"), "-1"));
        node.put("pageNo", StrUtil.nullToDefault((String) queryMap.get("page"), "1"));
        node.put("idCursor", StrUtil.nullToDefault((String) queryMap.get("idCursor"), "-1"));
        node.put("pageSize", StrUtil.nullToDefault((String) queryMap.get("pageSize"), "100"));
    }
