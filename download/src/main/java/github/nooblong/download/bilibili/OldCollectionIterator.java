...
public class OldCollectionIterator extends SimplePageIterator {
    ...
    public OldCollectionIterator(BilibiliBatchIteratorFactory factory, int limitSec,
        ...
        if (this.videos == null) {
            ...
            if (videoOrder == VideoOrder.PUB_NEW_FIRST_THEN_OLD) {
                IteratorCollectionTotalList<SimpleVideoInfo> collectionVideoListFromBilibili =
                        factory.getOldCollectionVideoListFromBilibili(collectionId, pageSize, 1, collectionVideoOrder,
                                bilibiliCookie);
                ...
                IteratorCollectionTotalList<SimpleVideoInfo> collectionVideoListFromBilibili =
                        factory.getOldCollectionVideoListFromBilibili(collectionId, pageSize,
