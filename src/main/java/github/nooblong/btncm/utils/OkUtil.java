...
public class OkUtil {
    ...
    public static Request uploadWeApi(long length, InputStream inputStream, String url, Map<String, String> header, String method,
        ...
        RequestBody requestBody = createRequestBody(MediaType.parse(mediaType), inputStream, length);
    ...
    public static Request uploadImgWeapi(long length, InputStream inputStream, String xNosToken, String objectKey) {
        RequestBody requestBody = createRequestBody(MediaType.parse("image/jpeg"), inputStream, length);
    ...
    public static RequestBody createRequestBody(MediaType mediaType, InputStream inputStream, long contentLength) {
